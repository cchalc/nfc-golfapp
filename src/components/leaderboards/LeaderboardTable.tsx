			...
			<Table.Root style={{ minWidth: "400px" }}>
				<Table.Header>
					<Table.Row>
						...
						{showRounds && (
							<Table.ColumnHeaderCell className="hide-mobile">
								Rounds
								...
								<Table.Cell>
									{isExcluded ? (
										...
										<Flex align="center" gap="1">
											<Trophy
												size={14}
												className={getTrophyClass(entry.rank)}
											/>
											<Text
												weight="bold"
												data-testid={`rank-${entry.golferId}`}
											>
												{entry.rank}
											</Text>
										</Flex>
									...
									>
										<Flex align="center" gap="2">
											<Avatar
												...
												radius="full"
												color={
													isLeader ? "amber" : isExcluded ? "gray" : undefined
												}
											/>
											<Text
												weight={
													!isExcluded && entry.rank <= highlightTop
														? "medium"
														: "regular"
												}
