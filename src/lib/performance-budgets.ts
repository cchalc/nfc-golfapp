...
export const BUDGET_CONFIGS = {
	leaderboardRender: createBudget(
		"leaderboard-render",
		PERFORMANCE_BUDGETS.LEADERBOARD_RENDER,
	),
	leaderboardAggregation: createBudget(
		"leaderboard-aggregation",
		PERFORMANCE_BUDGETS.QUERY_AGGREGATION,
	),
	scorecardRender: createBudget(
		"scorecard-render",
		PERFORMANCE_BUDGETS.SCORECARD_RENDER,
	),
	scorecardUpdate: createBudget(
		"scorecard-update",
		PERFORMANCE_BUDGETS.SCORECARD_UPDATE,
	),
	queryExecution: createBudget(
		"query-execution",
		PERFORMANCE_BUDGETS.QUERY_EXECUTION,
	),
	shapeSync: createBudget("shape-sync", PERFORMANCE_BUDGETS.SHAPE_SYNC),
	pageTransition: createBudget(
		"page-transition",
		PERFORMANCE_BUDGETS.PAGE_TRANSITION,
	),
} as const;
