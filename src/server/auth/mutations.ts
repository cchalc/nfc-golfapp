...
// ============================================================================
// Email Allowlist (Beta Testing)
// ============================================================================

const ALLOWED_EMAILS = new Set([
	"grahamsadoway@gmail.com",
	"sefienolte@gmail.com",
	"christopher.chalcraft@databricks.com", // Admin
	"chris.chalcraft@gmail.com", // Admin (personal)
]);
...
export const requestMagicLink = createServerFn({ method: "POST" })
	...
	.handler(
		async ({
			...
			// Check allowlist during beta
			if (!ALLOWED_EMAILS.has(normalizedEmail)) {
				console.log(`[Auth] Blocked login attempt from: ${normalizedEmail}`);
				return {
					success: false,
					error:
						"This app is currently in private beta. Contact the organizer for access.",
				};
			}
